...
gulp.task('javascript', ['javascript:foundation']);
...
gulp.task('javascript:plugin-core', function () {
    return gulp.src('bower_components/foundation-sites/js/entries/plugins/foundation.core.js')
        .pipe(named())
...
gulp.task('javascript:plugins', ['javascript:plugin-core'], function () {
    return gulp.src(['bower_components/foundation-sites/js/entries/plugins/*.js', '!bower_components/foundation-sites/js/entries/plugins/foundation.core.js'])
        .pipe(named())
...
gulp.task('javascript:foundation', ['javascript:plugins'], function () {
    return gulp.src('bower_components/foundation-sites/js/entries/foundation.js')
        .pipe(named())
        .pipe(webpackStream({externals: {jquery: 'jQuery'}, module: moduleConfig}, webpack2))
        .pipe(gulp.dest('js'));
});